...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:6702", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "黎栀", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "黎栀", "小黎"),
